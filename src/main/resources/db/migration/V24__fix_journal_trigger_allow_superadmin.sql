-- V24: Sửa trigger để cho phép SUPER_ADMIN tạo journal mà không cần phân công vào class_teachers
-- SUPER_ADMIN có thể tạo journal cho bất kỳ lớp nào
-- Teacher thường vẫn phải được phân công vào lớp
...
-- Tạo lại trigger INSERT với logic mới
DELIMITER $$
...
-- Tạo lại trigger UPDATE với logic mới
...
COMMENT = 'Nhật ký lớp học - SUPER_ADMIN có thể tạo cho bất kỳ lớp, TEACHER phải được phân công';
